...
<div class="pusher">
    ...
    <form class="ui form" method="post" action="controladorCompra.php?funcao=cadastro" style="margin-top: 2%;margin-left: 17%;width: 65%;background-color: #e0e0e0;padding-left: 1%;
	padding-top: 1%;
  padding-right: 1%;
  padding-bottom: 1%;
  margin-bottom: 5%;">
        ...
        <div class="field">
            ...
            <div class="three fields">
                ...
                <div class="field">
                    <input type="text" name="cd_cpf" id="cd_cpf" placeholder="CPF">
                </div>
            </div>
        ...
        <div class="field">
            ...
            <div class="fields">
                <div class="twelve wide field">
                    <input type="text" name="endereco" id="endereco" placeholder="Cidade, Rua">
                </div>
        ...
        <h4 class="ui dividing header">Horário de Entrega</h4>
        <div class="ui input">
            <div class="input">
                <input type="time" id="horarioEntrega" name="horarioEntrega">
            </div>
        </div>
        <h4 class="ui dividing header">Não quero pagar com cartão de crédito</h4>
        <div class="ui buttons">
            <button class="ui green button" value="1" name="formaPagamento" id="formaPagamento">Pagar com Dinheiro ao Entregador</button>
        </div>
